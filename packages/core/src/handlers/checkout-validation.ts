...
export const RESERVED_KEYS = ['title', 'description', 'successUrl'] as const
...
function validateNullBytes(key: string, value: string): Result<void, MetadataValidationError> {
  if (value.includes('\0')) {
    return err({
...
function validateControlCharacters(key: string, value: string): Result<void, MetadataValidationError> {
...
function validateUtf8Encoding(key: string, value: string): Result<void, MetadataValidationError> {
  try {
...
function validateMetadataSize(metadata: Record<string, string>): Result<void, MetadataValidationError> {
...
function validateValue(key: string, value: string): Result<void, MetadataValidationError> {
