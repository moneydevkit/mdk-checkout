...
import type { ServerCreateCheckoutResult } from './types'
...
): Promise<ServerCreateCheckoutResult> {
    ...
    const checkout = await client.checkouts.create(
      {
        ...
        // Skip webhook verification in preview environments
        skipWebhookVerification: is_preview_environment(),
      },
      node.id,
    )
