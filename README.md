...
- `create` – Developer onboarding CLI located in `packages/create`.
...
### create CLI
Run `npx @moneydevkit/create` from your project root to provision API keys, webhook secrets, and mnemonics. The CLI writes `.env.local` files that `mdk-checkout` consumes.
